...
pub fn build(b: *std.Build) !void {
    ...
    //         .target = b.resolveTargetQuery(std.Build.parseTargetQuery(.{ .arch_os_abi = "wasm32-freestanding" }) catch unreachable),
    //         .optimize = optimize,
    ...
    //     .install_subdir = "",
    // });
    // const compile_typescript = b.addSystemCommand(&.{ "bun", "build" });
    // compile_typescript.addFileArg(b.path("web/main.mts"));

    // const compiled_typescript = compile_typescript.captureStdOut();
    ...
    // web_step.dependOn(
    //     &b.addInstallFileWithDir(compiled_typescript, .{ .custom = "web" }, "main.js").step,
    // );
}
